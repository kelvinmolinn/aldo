...
$routes->group('compras/admin-retaceo', function($routes) {
    ...
    $routes->post('form/anular/retaceo', 'compras\administracionRetaceo::modalAnularRetaceo');
    $routes->post('anular/retaceo', 'compras\administracionRetaceo::operacionAnularRetaceo');
    $routes->post('operacion/actualizar/retaceo', 'compras\administracionRetaceo::vistaActualizarRetaceo');
...
$routes->group('ventas/admin-facturacion', function($routes) {
    ...
    $routes->post('anular/dte', 'ventas\administracionFacturacion::operacionAnularDTE');
    ...
    $routes->post('modal/nueva/notaCredito', 'ventas\administracionFacturacion::modalNuevoProductoNotaCredito'); 
    $routes->post('operacion/guardar/NuevaNotaCredito', 'ventas\administracionFacturacion::modalNuevoNotaCreditoOperacion');
    $routes->post('operacion/select/notaCredito', 'ventas\administracionFacturacion::selectNotaCredito');
    $routes->post('operacion/certificar/notaCredito', 'ventas\administracionFacturacion::certificarNotaCredito');
...
$routes->group('ventas/admin-contingencia', function($routes) {
    ...
    $routes->post('tabla/ver/json/contingencia','ventas\administracionContingencia::verJsonContingencia');
