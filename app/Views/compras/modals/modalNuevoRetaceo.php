            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                            <div class="col-md-6">
                                <div class="form-outline">
                                    <input type="number" id="fleteRetaceo" name="fleteRetaceo" class="form-control" min = "0.00" step="0.01" required>
                            ...
                            <div class="col-md-6">
                                    <div class="form-outline">
                                        <input type="number" id="GastosRetaceo" name="GastosRetaceo" class="form-control" min = "0.00" step="0.01" required>
