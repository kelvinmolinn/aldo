...
<form id="frmModal" method="post" action="">
    <div id="modalDetalleComprasRetaceo" class="modal fade modal-fullscreen" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                            ...
                                            foreach ($detalles AS $detalleCompra) {
                                                ...
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td>$ '.number_format($detalleCompra['costoUnitarioRetaceo'], 2, '.', ',').'</td>
                                                        <td>'.$detalleCompra['cantidadProducto'].'</td>
                                                        <td>$ '.number_format($detalleCompra['importe'], 2, '.', ',').'</td>
                                                        <td>$ '.number_format($detalleCompra['flete'], 2, '.', ',').'</td>
                                                        <td>$ '.number_format($detalleCompra['gasto'], 2, '.', ',').'</td>
                                                        <td>$ '.number_format($detalleCompra['DAI'], 2, '.', ',').'</td>
                                                        <td>$ '.number_format($detalleCompra['costoTotal'], 2, '.', ',').'</td>
                                                ';
                                            }
                                        ?>
                                    </tbody>
