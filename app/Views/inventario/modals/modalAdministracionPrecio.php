                ...
                <div class="modal-body">
                    ...
                    <div class="container modal-body">
                        <div class="form-outline position-relative">
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <input type="number" id="precioVentaNuevo" class="form-control number-input" name="precioVentaNuevo" placeholder="Nuevo precio de venta" step="0.01" value="<?= $campos['precioVentaNuevo'] ?>" readonly required>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#tblPrecio').DataTable({
            "ajax": {
                "method": "POST",
                "url": '<?= base_url('inventario/admin-producto/tabla/precio'); ?>',
                "data": {
