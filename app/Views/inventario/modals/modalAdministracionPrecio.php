            ...
            <div class="modal-content">
                ...
                <div class="container modal-body">
                    <div class="form-outline position-relative">
                           <div class="row mt-2">
                        <div class="col-md-4">
                            <input type="number" id="precioVentaNuevo" class="form-control  number-input" name="precioVentaNuevo"  placeholder="Nuevo precio de venta" step="0.01"  readonly required>
