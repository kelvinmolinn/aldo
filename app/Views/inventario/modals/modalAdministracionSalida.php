...
<form id="frmModal" action="<?= base_url('inventario/admin-salida/operacion/guardar/salida') ?>" method="POST">
    <div id="modalSalida" class="modal" tabindex="-1" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?= ($operacion == 'editar' ? 'Editar Producto' : 'Nueva salida inicial'); ?></h5>
                </div>
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            $("#tblSalida").DataTable().ajax.reload(null, false);
                            
                        });
                        console.log("Último ID insertado:", response.descargosId);
