<form id="frmContinuarDTE" method="post" action="<?php echo base_url('ventas/admin-facturacion/operacion/actualizar/dte'); ?>">
    ...
    <h2>Continuar Nota de Crédito</h2>
    <hr>
    ...
    <div class="row mb-2">
        <div class="col-md-4">
            <div class="form-select-control">
                <select name="sucursalId" id="sucursalId" class="form-control" style="width: 100%;" disabled>
                    <option></option>
        ...
        <div class="col-md-4">
            <div class="form-select-control">
                <select name="tipoDTEId" id="tipoDTEId" class="form-control" style="width: 100%;" disabled>
                    <option></option>
    ...
    <div class="row mt-4 mb-4">
        <div class="col-md-6">
            <div class="form-select-control">
                <select name="clienteId" id="clienteId" class="form-control" style="width: 100%;" disabled>
                    <option></option>
        ...
        <div class="col-md-6">
            <div class="form-select-control">
                <select name="empleadoId" id="empleadoId" style="width: 100%;" disabled>
                    <option></option>
...
<div class="table-responsive">
    <table class="table table-hover" id="tablaContinuarNotaCredito" style="width: 100%;">
        <thead>
            <tr>
                <th>#</th>
                <th>Producto</th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#btnRegresarReserva').on('click', function() {
            ...
            // Habilitar temporalmente los campos select antes de enviar el formulario
            $('#frmContinuarDTE').on('submit', function(event) {
            $('#sucursalId, #tipoDTEId, #clienteId, #empleadoId').prop('disabled', false);
        });
        ...
        $('#tablaContinuarNotaCredito').DataTable({
            "ajax": {
                "method": "POST",
                "url": '<?php echo base_url('ventas/admin-facturacion/tabla/continuar/notaCredito'); ?>',
                "data": {
                    facturaId: '<?= $facturaId; ?>'
                }
            },
