...
class inv_descargos extends Model
{
    protected $table = 'inv_descargos';
    protected $primaryKey = 'descargosId'; // si el nombre de la clave primaria es diferente
    protected $allowedFields = ['sucursalId','fhDescargo','obsDescargo','estadoDescargo','flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina'];
