...
class comp_compras extends Model
{
    ...
    protected $allowedFields = ['compraId', 'proveedorId', 'tipoDTEId', 'fechaDocumento', 'numDocumento', 'paisId', 'ObsCompra', 'porcentajeIva', 'flgRetaceo', 'estadoCompra', 'fechaAnulacion', 'obsAnulacion', 'flgElimina'];
