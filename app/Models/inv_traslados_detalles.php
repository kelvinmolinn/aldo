...
class inv_traslados_detalles extends Model
{
    protected $table = 'inv_traslados_detalles';
    protected $primaryKey = 'trasladoDetalleId'; // si el nombre de la clave primaria es diferente
    protected $allowedFields = ['trasladosId','productoId','cantidadSolicitud','cantidadTraslado','obsTrasladoSolicitudDetalle','flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina'];
