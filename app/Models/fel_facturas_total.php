...
class fel_facturas_total extends Model
{
    protected $table = 'fel_facturas_total';
    protected $primaryKey = 'facturaTotalId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['facturaTotalId', 'facturaId', 'totalFactura', 'ivaRetenido', 'ivaTotal', 'totalFacturaIVA', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
