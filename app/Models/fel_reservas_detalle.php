...
class fel_reservas_detalle extends Model
{
    protected $table = 'fel_reservas_detalle';
    protected $primaryKey = 'reservaDetalleId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['reservaDetalleId', 'reservaId', 'productoId', 'cantidadProducto', 'precioUnitario', 'precioUnitarioIVA', 'porcentajeDescuento', 'precioUnitarioVenta', 'precioUnitarioVentaIVA', 'ivaUnitario', 'ivaTotal', 'totalReservaDetalle', 'totalReservaDetalleIVA', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
