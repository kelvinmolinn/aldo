...
class cat_11_tipo_item extends Model
{
    protected $table = 'cat_11_tipo_item';
    protected $primaryKey = 'tipoItemMHId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['tipoItemMHId', 'tipoItem', 'codigoMH', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
