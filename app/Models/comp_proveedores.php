...
class comp_proveedores extends Model
{
    ...
    protected $allowedFields = ['proveedorId', 'tipoProveedorOrigen', 'tipoPersonaId', 'documentoIdentificacionId', 'ncrProveedor', 'numDocumentoIdentificacion', 'proveedor', 'proveedorComercial', 'actividadEconomicaId', 'tipoContribuyenteId', 'direccionProveedor', 'estadoProveedor', 'flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina'];
