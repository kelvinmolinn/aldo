...
class cat_20_paises extends Model
{
    ...
    protected $allowedFields = ['paisId','pais','abreviaturaPais','codigoTelefonoPais','codigoMH','flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina'];
