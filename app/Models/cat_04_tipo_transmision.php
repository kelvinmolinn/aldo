...
class cat_04_tipo_transmision extends Model
{
    protected $table = 'cat_04_tipo_transmision';
    protected $primaryKey = 'tipoTransmisionMHId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['tipoTransmisionMHId', 'tipoTransmision', 'codigoMH', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
