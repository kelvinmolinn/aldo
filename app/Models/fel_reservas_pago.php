...
class fel_reservas_pago extends Model
{
    protected $table = 'fel_reservas_pago';
    protected $primaryKey = 'reservaPagoId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['reservaPagoId', 'reservaId', 'fechaReservaPago', 'formaPagoMHId', 'numComprobantePago', 'montoPago', 'comentarioPago', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
