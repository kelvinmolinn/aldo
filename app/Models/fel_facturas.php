...
class fel_facturas extends Model
{
    protected $table = 'fel_facturas';
    protected $primaryKey = 'facturaId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['facturaId', 'sucursalId', 'tipoDTEId', 'fechaEmision', 'horaEmision', 'clienteId', 'empleadoIdVendedor', 'condicionFacturaMHId', 'plazoPagoMHId', 'periodoPlazo', 'porcentajeIVA', 'estadoFactura', 'obsAnulacion', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
