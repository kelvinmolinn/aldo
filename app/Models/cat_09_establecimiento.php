...
class cat_09_establecimiento extends Model
{
    protected $table = 'cat_09_establecimiento';
    protected $primaryKey = 'establecimientoMHId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['establecimientoMHId', 'tipoEstablecimiento', 'codigoMH', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
