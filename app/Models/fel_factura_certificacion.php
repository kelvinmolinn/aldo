...
class fel_factura_certificacion extends Model
{
    protected $table = 'fel_factura_certificacion';
    protected $primaryKey = 'facturaCertificacionId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['facturaCertificacionId', 'facturaId', 'numeroControl', 'codigoGeneracion', 'tipoTransmisionMHId', 'selloRecibido', 'descripcionMensaje', 'estadoCertificacion', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
