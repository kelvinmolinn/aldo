...
class comp_compras_detalle extends Model
{
    ...
    protected $allowedFields = ['compraDetalleId', 'compraId', 'productoId', 'cantidadProducto', 'precioUnitario', 'precioUnitarioIVA', 'ivaUnitario', 'ivaTotal', 'totalCompraDetalle', 'totalCompraDetalleIVA', 'flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina'];
