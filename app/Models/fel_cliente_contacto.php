...
class fel_cliente_contacto extends Model
{
    protected $table = 'fel_cliente_contacto';
    protected $primaryKey = 'clienteContactoId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['clienteContactoId', 'clienteId', 'tipoContactoId', 'contactoCliente', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
