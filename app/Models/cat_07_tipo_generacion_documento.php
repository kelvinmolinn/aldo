...
class cat_07_tipo_generacion_documento extends Model
{
    protected $table = 'cat_07_tipo_generacion_documento';
    protected $primaryKey = 'tipoGeneracionDocumentoId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['tipoGeneracionDocumentoId', 'tipoGeneracionDocumento', 'codigoMH', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
            //Agregar desde aqui
