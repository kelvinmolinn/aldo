...
class fel_facturas_pago extends Model
{
    protected $table = 'fel_facturas_pago';
    protected $primaryKey = 'facturaPagoId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['facturaPagoId', 'facturaId', 'formaPagoMHId', 'descripcionPago', 'totalPago', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
