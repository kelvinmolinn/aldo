...
class cat_22_documentos_identificacion extends Model
{
    ...
    protected $allowedFields = ['documentoIdentificacionId','documentoIdentificacion','formatoDocumentoIdentificacion','codigoMH','flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina'];
