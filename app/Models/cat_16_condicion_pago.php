...
class cat_16_condicion_pago extends Model
{
    protected $table = 'cat_16_condicion_pago';
    protected $primaryKey = 'condicionFacturaMHId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['condicionFacturaMHId', 'condicionPago', 'codigoMH', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
