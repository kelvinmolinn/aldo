...
class fel_factura_contingencia_detalle extends Model
{
    protected $table = 'fel_factura_contingencia_detalle';
    protected $primaryKey = 'facturaContingenciaDetalleId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['facturaContingenciaDetalleId', 'facturaContingenciaId', 'facturaId', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
