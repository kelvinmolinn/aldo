...
class cat_13_paises_estados extends Model
{
    protected $table = 'cat_13_paises_estados';
    protected $primaryKey = 'paisEstadoId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['paisEstadoId', 'codigoMH', 'paisCiudadId', 'paisEstado', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
