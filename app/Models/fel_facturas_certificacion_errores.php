...
class fel_facturas_certificacion_errores extends Model
{
    protected $table = 'fel_facturas_certificacion_errores';
    protected $primaryKey = 'facturaCertificacionErrorId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['facturaCertificacionErrorId', 'facturaCertificacionId', 'codigoError', 'descripcionError', 'obsError', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
