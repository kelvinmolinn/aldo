...
class cat_18_plazo_pago extends Model
{
    protected $table = 'cat_18_plazo_pago';
    protected $primaryKey = 'plazoPagoMHId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['plazoPagoMHId', 'plazoPago', 'codigoMH', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
