...
class conf_usuarios extends Model
{
    ...
    protected $allowedFields = ['empleadoId','rolId','correo','clave','estadoUsuario','flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina'];
