...
class fel_factura_relacionada extends Model
{
    protected $table = 'fel_factura_relacionada';
    protected $primaryKey = 'facturaRelacionadaId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['facturaRelacionadaId', 'facturaId', 'facturaIdRelacionada', 'tipoDTEId', 'tipoGeneracionDocumentoId', 'numeroDocumentoRelacionada', 'fechaEmisionRelacionada', 'horaEmisionRelacionada', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
            //Agregar desde aqui
