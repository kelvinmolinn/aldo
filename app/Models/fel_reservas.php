...
class fel_reservas extends Model
{
    protected $table = 'fel_reservas';
    protected $primaryKey = 'reservaId'; // si el nombre de la clave primaria es diferente

    protected $allowedFields = ['reservaId', 'sucursalId', 'clienteId', 'facturaId', 'fechaReserva', 'comentarioReserva', 'porcentajeIva', 'estadoReserva', 'fechaAnulacionReserva', 'obsAnulacionReserva', 'fhEdita', 'fhAgrega', 'usuarioIdEdita', 'usuarioIdAgrega', 'flgElimina', 'fhElimina', 'usuarioIdElimina'];
