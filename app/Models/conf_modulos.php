...
class conf_modulos extends Model
{
    ...
    protected $allowedFields = ['modulo','iconoModulo','urlModulo','flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina']; // Campos permitidos para la inserción
