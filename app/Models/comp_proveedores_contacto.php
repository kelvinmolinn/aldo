...
class comp_proveedores_contacto extends Model
{
    ...
    protected $allowedFields = ['proveedorContactoId', 'proveedorId', 'tipoContactoId', 'contactoProveedor', 'flgElimina','fhAgrega','fhEdita','usuarioIdAgrega','usuarioIdEdita','fhElimina','usuarioIdElimina'];
